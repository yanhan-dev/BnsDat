...
namespace BnsDat
{
    ...
    public class BNSDat
    {
        ...
        public void Extract(string FileName, bool is64 = false, Func<int, int> dispalyProgress = null)
        {
            ...
            for (int i = 0; i < FileCount; i++)
            {
                ...
                dispalyProgress?.Invoke(Convert.ToInt32(((i + 1) * 1.0 / (FileCount * 1.0)) * 100));
                // 解包状态
                // End report progress
            }
        ...
        public void Compress(string Folder, bool is64 = false, Func<int, int> dispalyProgress = null, int compression = 9)
        {
            string file_path;
            byte[] buffer_packed;
            byte[] buffer_unpacked;
